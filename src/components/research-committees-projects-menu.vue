...
<template>
  <button @mouseover="showMenu = true" @mouseleave="showMenu = false">
    <a class="flex"> Research Committees & Projects </a>
    <ul
      :class="{
        'flex flex-col bg-white    items-start       text-black': showMenu,
        'hidden ': !showMenu,
      }"
    >
      ...
      <li class="px-5 py-3 hover:border-b-2 border-red-600">
        Career Development and Fellowship Committee
      </li>
      <li class="px-5 py-3 hover:border-b-2 border-red-600">
